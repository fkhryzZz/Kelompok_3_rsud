...
<head>
    ...
    <title>Tambah Departemen - RSUD Bakti Permana</title>
...
<body>
    ...
    <div class="app-container">
        ...
        <main class="main-content position-relative">
            ...
            <!-- Page Title -->
            <div class="mb-4">
                <h4 class="fw-bold mb-1" style="color: var(--primary-text);">Tambah Departemen Baru</h4>
                <span style="font-size: 0.85rem; color: var(--muted-text);">Isi formulir di bawah ini untuk menambahkan departemen atau layanan medis baru ke sistem.</span>
            </div>

            <!-- Form Card -->
            <div class="form-card">
                <!-- Action di arahkan ke file proses PHP Anda -->
                <form action="insert_proses.php" method="POST">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_departemen" class="form-control-custom" placeholder="Misal: Poli Jantung" required>
                        </div>

                        <!-- Input Judul Layanan -->
                        <div class="col-md-6">
                            <label class="custom-label">Kategori / Judul Layanan <span class="text-danger">*</span></label>
                            <input type="text" name="judul_layanan" class="form-control-custom" placeholder="Misal: Layanan Kardiologi" required>
                        </div>

                        <!-- Input Deskripsi -->
                        <div class="col-12">
                            <label class="custom-label">Deskripsi Departemen <span class="text-danger">*</span></label>
                            <textarea name="deskripsi" class="form-control-custom" placeholder="Tuliskan deskripsi lengkap mengenai layanan, fasilitas, atau spesialisasi yang ada pada departemen ini..." required></textarea>
                        </div>

                        <!-- Action Buttons -->
                        <div class="col-12 mt-5 d-flex gap-3">
                            <button type="submit" class="btn-submit">
                                <i data-lucide="save" size="18"></i> Simpan Data Departemen
                            </button>
